...
#if __has_include("LabelTrack.h")
#include "LabelTrack.h"
#elif __has_include("tracks/labeltrack/LabelTrack.h")
#include "tracks/labeltrack/LabelTrack.h"
#else
#error "LabelTrack header not found. Set AUDACITY_SOURCE_DIR to a compatible Audacity source tree."
#endif
#include "Project.h"
...
#include "Track.h"
#include "TrackList.h"
#if __has_include("WaveTrack.h")
#include "WaveTrack.h"
#elif __has_include("tracks/wavetrack/WaveTrack.h")
#include "tracks/wavetrack/WaveTrack.h"
#else
#error "WaveTrack header not found. Set AUDACITY_SOURCE_DIR to a compatible Audacity source tree."
#endif
